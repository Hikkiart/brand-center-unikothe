...
function bcek_activate_plugin() {
    ...
    // --- NOVA TABELA: Categorias de Templates ---
    $table_name_categories = $wpdb->prefix . 'bcek_template_categories';
    ...
    // Tabela de Templates (COM A NOVA COLUNA category_id)
    ...
    // Tabela de Campos (sem alterações)
    ...
    update_option('bcek_db_version', '2.5.0'); // Atualiza a versão para referência
}