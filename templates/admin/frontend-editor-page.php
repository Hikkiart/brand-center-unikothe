...
// absint() garante que seja um número inteiro e absoluto (sempre >= 0)
// wp_unslash() remove barras invertidas adicionadas automaticamente pelo PHP/WP
...
// Define uma imagem de placeholder se não houver uma imagem base
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <select id="template-category" class="w-full bg-white rounded-lg p-3 border border-gray-300 focus:ring-2 focus:ring-blue-500">
                        <option value="0"><?php _e('Sem Categoria', 'bcek'); ?></option>
                        <?php if (!empty($categories)) : ?>
                            <?php foreach ($categories as $category) : ?>
                                <option value="<?php echo esc_attr($category->category_id); ?>" <?php selected($template_data->category_id ?? 0, $category->category_id); ?>>
